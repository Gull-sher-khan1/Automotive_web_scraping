...
class AutomotiveWebScrapingSpiderMiddleware:
    ...
    def process_spider_exception(self, response, exception, spider):
        ...
        subject = f'An exception has occured while processing spider for url: {response.url}'
...
class AutomotiveWebScrapingDownloaderMiddleware:
    """Not all methods need to be defined. If a method is not defined,
    ...
    def process_exception(self, request, exception, spider):
        ...
        subject = f'An exception has occured whithin download handler for url: {request.url}'
        spider.exception_handler.assign_data({
            subject: exception
        })

    def spider_opened(self, spider):
        """Callback that runs when spider is opened"""
        spider.logger.info(f"Spider opened: {spider.name}")
